...
public class CommentsTests extends BaseTest {
    ...
    LatestPostPage latestPostPage = new LatestPostPage();
    HomePage homePage = new HomePage();
    CommentPage commentPage = new CommentPage();
    EditCommentPage editCommentPage = new EditCommentPage();

    DeleteCommentPage deleteCommentPage = new DeleteCommentPage();
